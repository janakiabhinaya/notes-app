...
import { Mainpart } from "./rightcomponent";
  ...
  const handleChange = (e) => {
    ...
    return(
      ...
      {groups.map((group, index) => (
                ...
                <div className={styles.textblock}><Mainpart
        activeGroup={activeGroup}// Pass the active group to the Mainpart component
        typedText={typedText}
        setTypedText={setTypedText}
        handleChange={handleChange}
        saveTextInGroup={saveTextInGroup}
      /></div>   
    </div>
    );
}
